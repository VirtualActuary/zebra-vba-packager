...
Private Function MiscOs_ConvertToBackslashes(pth As String) As String
    MiscOs_ConvertToBackslashes = Replace(pth, "/", "\")
...
Public Function EvalPath(pth As String, Optional WB As Workbook) As String
    ...
    EvalPath = MiscOs_ConvertToBackslashes(EvalPath)
